...
namespace FunUtilities
{
   ...
   public class HackerScannerPrint
   {
      ...
      private readonly string stringToPrint = "";
      private readonly string backspaces = "";
      private readonly char markerCharacter = '-';
      /// <summary>
...
namespace AoCLeaderBoardClasses
{
   public class LeaderBoard
   {
      ...
      private string url = @"https://adventofcode.com/2021/leaderboard/private/view/100445.json"; // default
      ...
      public void DoProcess()
      {
         ...
         //2021 session cookie
         //request.CookieContainer.Add(new Cookie("session", "53616c7465645f5f30adba27ed2e79f91c1fd724c1586de273179d86fa97e0e337d9d0f7ad2a8e0e9e6a6319c0ef3ed1", "/", ".adventofcode.com"));
         //2022 session cookie
         request.CookieContainer.Add(new Cookie("session", "53616c7465645f5f79e14b9efa3fa89fa2a204b4a87a1aad11ab3085d802335ef2ac9a1923a3487834fc18e737ecdfaf09154d801dc026ebe5f95a6bb5e464bf", "/", ".adventofcode.com"));
         ...
         leaderboard.owner_id = (int)mutableHelperObject["owner_id"];
         ...
         foreach (string key in mutableHelperObject.Keys)
         {
            ...
            foreach (string dkey in memberObject.Keys)
            {
               ...
               if (dayo.ContainsKey("1")) { thisday.stars.Add(new Star() { id = "1", earned_star_ts_epoch = long.Parse((((Dictionary<string, object>)dayo["1"])["get_star_ts"]).ToString()) }); }
               if (dayo.ContainsKey("2")) { thisday.stars.Add(new Star() { id = "2", earned_star_ts_epoch = long.Parse((((Dictionary<string, object>)dayo["2"])["get_star_ts"]).ToString()) }); }
