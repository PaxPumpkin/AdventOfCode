    ...
    class zLeaderBoard : AoCodeModule
    {
        ...
        public override void DoProcess()
        {
            ...
            foreach (string key in helper.Keys)
            {
                ...
                member.last_star_ts = long.Parse((string)membero["last_star_ts"]);
        ...
        private void outputMemberInfo(Member member)
        {
            ...
            member.days.ForEach(y => {
                ...
                if (y.stars.Count > 1)
                {
                    ...
                    Console.WriteLine("** Time between stars: " + duration.Hours.ToString() + " Hours, " + duration.Minutes.ToString() + " minutes, " + duration.Seconds.ToString() + " seconds");
                }
                counter++;
            });
            Console.WriteLine();
